...
namespace :doc do
  ...
  task :sentencing_counties do
    ...
    #size:146 all of these sentences will have sentencing_counties_id
    ...
    sent_counties.each do |sent|
        ...
        if county_court.include? sent && sent != 'UNKNOWN COUNTY COURT'
            #county = County.find_by name: sent.split(' COUNTY COURT').first.titleize
            ...
            doc_sent.save
           # sentence.update(doc_sentencing_county_id:doc_sent.id)
