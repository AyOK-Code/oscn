    ...
    let(:expected_attributes) {
      {
        ...
        entry_date: DateTime.parse('2021-12-09 00:00:00.000000000 -0600'),
        filing_date: DateTime.parse('2021-12-09 00:00:00.000000000 -0600'),
        effective_date: DateTime.parse('2022-01-03 00:00:00.000000000 -0600'),
